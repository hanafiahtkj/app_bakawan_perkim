        ...
        <div class="main-wrapper">
                ...
                <nav class="navbar navbar-expand-lg main-navbar bg-primary">
                    <div class="container">
                        ...
                        <a class="navbar-brand d-none d-md-block" href="{{ url('') }}">
                            <img src="{{ asset('img/bakawan-logo.png') }}" width="35" height="35"
            ...
            <i class="fas fa-ellipsis-v"></i>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item {{ request()->is('sarat-dan-kententuan') ? 'active' : '' }}"><a
                                        href="{{ url('sarat-dan-kententuan') }}" class="nav-link">Syarat &
                                        Ketentuan</a></li>
                                ...
                                <li class="nav-item {{ request()->is('panduan') ? 'active' : '' }}"><a
                                        href="{{ url('panduan') }}" class="nav-link">Panduan</a></li>
                                <!-- <li class="nav-item"><a href="{{ url('video') }}" class="nav-link">Video</a></li> -->
                                <li class="nav-item dropdown {{ request()->is('post*') ? 'active' : '' }}"><a
                                        href="#" id="navbarDropdown" class="nav-link dropdown-toggle"
            ...
            <div class="search-backdrop"></div>
                        ...
                        <ul class="navbar-nav navbar-right">
                            @auth
                                <li class="dropdown"><a href="#" data-toggle="dropdown"
                                        ...
                                        <img alt="image"
                                            src="{{ asset(Auth::User()->foto != null ? Auth::User()->foto : 'img/avatar/avatar-1.png') }}"
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        @role('Admin')
                                            ...
                                            <a href="{{ route('admin.dashboard') }}" class="dropdown-item has-icon"><i
                                                    class="fas fa-home"></i> Dasbor</a>
                                        @else
                                            <a href="{{ url('/profile') }}" class="dropdown-item has-icon">
                                                <i class="far fa-user"></i> Profil
                                            </a>
                                            <a href="{{ route('dashboard') }}" class="dropdown-item has-icon"><i
                                                    class="fas fa-home"></i> Dasbor</a>
                                        @endrole
                ...
                <nav class="navbar navbar-secondary navbar-expand-lg d-none">
                    <div class="container">
                        <ul class="navbar-nav">
                            <li class="nav-item active"><a href="{{ url('') }}" class="nav-link">Beranda</a>
                            </li>
                            <li class="nav-item"><a href="{{ url('sarat-dan-kententuan') }}" class="nav-link">Syarat
                                    & Ketentuan</a></li>
                            ...
                            <!-- <li class="nav-item"><a href="{{ url('video') }}" class="nav-link">Video</a></li> -->
                            <li class="nav-item dropdown"><a href="#" id="navbarDropdown"
                                    class="nav-link has-dropdown" data-toggle="dropdown">Pengumuman</a>
                ...
                <footer class="main-footer p-3 text-white d-none d-md-inline-block"
                    style="
