<x-app-layout>
  ...
  <x-slot name="title">Detail (Rumah Tidak Layak Huni)</x-slot>
      ...
      <section class="section">
        <div class="section-header">
          ...
          <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Detail (Rumah Tidak Layak Huni)</div>
          </div>
        </div>
                  ...
                  <div class="collapse show" id="mycard-collapse2">
                    <div class="card-body">
                      <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                          <textarea class="form-control selectric" id="catatan" name="catatan" rows="3" style="height: 100px;"></textarea>
