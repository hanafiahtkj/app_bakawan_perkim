  ...
  <div class="main-content" id="app">
    <section class="section">
      ...
      <div class="section-body">
        ...
        <div class="row">
          <div class="col-12">
            <div class="card" id="file-manager">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-5 mb-3">
                    <a v-show="!is_directory" href="" @click.prevent="getDirectory()" data-toggle="tooltip" id="button-parent" class="btn btn-secondary" data-placement="top" title="Parent"><i class="fa fa-level-up-alt"></i></a> 
                    <a href="" data-toggle="tooltip" id="button-refresh" class="btn btn-success" data-placement="top" title="Refresh"><i class="fa fa-sync-alt" aria-hidden="true"></i></a>
                    <button v-show="!is_directory" type="button" data-toggle="tooltip" id="button-upload" class="btn btn-primary" data-placement="top" title="Upload"><i class="fa fa-upload"></i></button>
                    <button v-show="is_directory" type="button" data-toggle="tooltip" id="button-folder" class="btn btn-info" data-placement="top" title="New Folder"><i class="fa fa-folder"></i></button>
                    <button type="button" data-toggle="tooltip" id="button-delete" class="btn btn-danger" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button>
                ...
                <div class="row">
                  <div v-if="is_directory" v-for="(dir, index) in directory" :key="index" class="col-sm-3 col-xs-6 text-center mb-3">
                    <div class="text-center"><a href="#" @click.prevent="getFiles(dir.id)" class="directory" style="vertical-align: middle;"><i class="fa fa-folder fa-5x"></i></a></div>
				            <label><input type="checkbox" name="path[]" :value="dir.path" class="flat-red">  @{{ dir.name }}</label>
                  </div>
    ...
    var app = new Vue({
      ...
      methods: {
        ...
        getFiles: function (id_directory = '') 
        {
          ...
          if (id_directory != '') {
            var url = '{{ route("admin.getFiles", ":id") }}';
          ...
          $.ajax({
            ...
            success: function(json) {
              ...
              if (json['success']) {
                ...
                app.getDirectory();
                $('#file-manager #button-folder').popover('hide');
              }
            },
            error: function(xhr, ajaxOptions, thrownError) {
              alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
