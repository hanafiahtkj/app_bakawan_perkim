<x-admin-layout>
  ...
  <x-slot name="title">Setup Wilayah</x-slot>
    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Setup Wilayah</div>
        </div>
      </div>
              ...
              <div class="card-body">
                ...
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Kecamatan</label>
                  <div class="col-sm-12 col-md-6">
                    <select class="form-control" id="setup_id" @change="getSetups()">
                  ...
                  <table class="table table-striped table-bordered" id="table-usersxx">
                    ...
                    <tbody>
                      <tr v-for="(setup, index) in form.data" :key="index">
                        <td> 
                        <input type="text" class="form-control" v-model="setup.id">
                        </td>
                        <td> 
    ...
    var app = new Vue({
      ...
      methods: {
        getSetups: function () 
        {
          ...
          if (parent_id != '') {
            //var id = $(this).val();
            var url = '{{ route("admin.getDataSetupsWilayah", ":id") }}';
        ...
        submitForm()
        {
          ...
          $.ajax({
              type: "POST",
              url: "{{ route('admin.setup-wilayah.store') }}",
              data: formData,
              processData: false,
              contentType: false,
              dataType: "json",
        ...
        {
          var url = '{{ route("admin.setup-wilayah.destroy", ":id") }}';
