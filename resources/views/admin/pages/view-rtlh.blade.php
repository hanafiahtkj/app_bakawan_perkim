                  ...
                  <fieldset>
                    <div class="card-body">
                      <ul class="nav nav-tabs justify-content-center" id="myTab5" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="kondisi-tab" data-toggle="tab" href="#kondisi" role="tab" aria-controls="kondisi" aria-selected="false">
                            2. Kondisi Rumah</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="kelayakan-tab" data-toggle="tab" href="#kelayakan" role="tab" aria-controls="kelayakan" aria-selected="false">
                            3. Kelayakan Rumah</a>
                        </li>
                      </ul>
                        ...
                        <div class="tab-pane fade show active" id="identitas" role="tabpanel" aria-labelledby="identitas-tab">
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              <input type="text" class="form-control" name="nik" value="{{ $rtlh->nik }}">
                          ...
                          <!-- <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              <button type="button" class="btn btn-primary btn-lanjut" data-type="identitas" data-target="#kondisi">Lanjut</button>
                            </div>
                          </div> -->
                        </div>
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              ...
                              <div class="input-group">
                                <input type="text" class="form-control" name="foto_bangunan" value="{{ $kondisiRumah->foto_bangunan }}" readonly>
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              ...
                              <div class="input-group mb-3">
                                <input type="text" class="form-control"  name="koordinat_rumah" id="koordinat_rumah" value="{{ $kondisiRumah->koordinat_rumah }}">
                                <div class="input-group-append">
                  ...
                  <div class="collapse show" id="mycard-collapse2">
                    <div class="card-body">
                      <ul class="list-unstyled list-unstyled-border">
                        @foreach ($rtlhCatatan as $catatan)
                          <li class="media">
                            <img class="mr-3 rounded-circle" width="50" src="{{ asset('img/avatar/avatar-1.png') }}" alt="avatar">
                            <div class="media-body">
                              <div class="float-right text-primary">{{ $catatan->tgl_notif }}</div>
                              <div class="media-title">{{ $catatan->user->name }}</div>
                              <span class="text-small text-muted">{{ $catatan->catatan }}</span>
                            </div>
                          </li>
                        @endforeach 
                      </ul>
                  ...
                  <div class="collapse show" id="mycard-collapse2">
                    <div class="card-body">
                      <ul class="nav nav-tabs justify-content-center" id="myTab6" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" id="uploads-tab" data-toggle="tab" href="#uploads" role="tab" aria-controls="uploads" aria-selected="false">
                            1. Uploads</a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" id="verifikasi-tab" data-toggle="tab" href="#verifikasi" role="tab" aria-controls="verifikasi" aria-selected="false">
                            2. Data Verifikasi</a>
                        </li>
                      </ul>
                      <div class="tab-content tab-bordered" id="myTabContent7">
                        <!-- <div class="tab-pane fade show active" id="data" role="tabpanel" aria-labelledby="data-tab">
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">NIK / No.KTP</label>
                            <div class="col-sm-12 col-md-7">
                              <input type="text" class="form-control" name="nik" value="{{ $rtlhVerif->nik }}">
                              <div class="invalid-feedback feedback-nik"></div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Lengkap</label>
                            <div class="col-sm-12 col-md-7">
                              <input type="text" class="form-control" name="nama_lengkap" value="{{ $rtlhVerif->nama_lengkap }}">
                              <div class="invalid-feedback feedback-nama_lengkap"></div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Alamat Lengkap</label>
                            <div class="col-sm-12 col-md-7">
                              <textarea class="form-control selectric" name="alamat_lengkap" rows="3" style="height: 100px;">{{ $rtlhVerif->alamat_lengkap }}</textarea>
                              <div class="invalid-feedback feedback-alamat_lengkap"></div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              <select class="form-control selectric" name="jenis_pekerjaan">
                                <option value="">Pilih.....</option>
                                @foreach ($jenis_pek as $setup)
                                <option value="{{ $setup->id }}" {{ ( $rtlhVerif->jenis_pekerjaan == $setup->id) ? 'selected' : '' }}>{{ $setup->name }}</option>
                                @endforeach
                              </select>
                              <div class="invalid-feedback feedback-jenis_pekerjaan"></div>
                            </div>
                          ...
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Jumlah Penghasilan</label>
                            <div class="col-sm-12 col-md-7">
                              <input type="text" class="form-control" name="jml_penghasilan" value="{{ $rtlhVerif->jml_penghasilan }}">
                              <div class="invalid-feedback feedback-jml_penghasilan"></div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              ...
                              <div class="input-group mb-3">
                                <input type="text" class="form-control"  name="koordinat_rumah" id="koordinat_rumah" value="{{ $rtlhVerif->koordinat_rumah }}">
                                <div class="input-group-append">
                                  <button class="btn btn-success" type="button" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-map-marker-alt"></i></button>
                                </div>
                              </div>
                        ...
                        <div class="tab-pane fade show active" id="uploads" role="tabpanel" aria-labelledby="uploads-tab">
                          ...
                          @foreach ($rtlhVerifFiles as $setup)
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ $setup->name }}</label>
                            <div class="col-sm-12 col-md-7">
                              <!-- <input type="file" class="form-control" name="foto_bangunan"> -->
                              <div class="input-group">
                                <input type="text" class="form-control" value="{{ $setup->files }}" readonly>
                                <div class="input-group-append">
                                  <a class="btn btn-secondary btn-img" href="{{ url($setup->files) }}" target="_blank"><i class="fas fa-image"></i></a>
                                </div>
                              </div>
                              <!-- <div class="invalid-feedback feedback-foto_bangunah"></div> -->
                            </div>
                          ...
                          <!-- <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                            <div class="col-sm-6 col-md-3">
                            <button type="button" class="btn btn-secondary btn-kembali" data-target="#data"><i class="fas fa-angle-double-left"></i> Kembali</button>
                            </div>
                            <div class="col-sm-6 col-md-4 text-right">
                            <button type="button" class="btn btn-primary btn-lanjut" data-type="uploads" data-target="#verifikasi">Lanjut <i class="fas fa-angle-double-right"></i></button>
                            </div>
                          </div> -->
                        </div>
                        <div class="tab-pane fade" id="verifikasi" role="tabpanel" aria-labelledby="verifikasi-tab">
                          
                          @foreach ($dataVerif as $setup)
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ $setup->name }}</label>
                            <div class="col-sm-12 col-md-7">
                              @foreach ($setup->fieldValue as $value)
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="custom_field[{{ $setup->id}}]" type="radio" 
                                id="custom_field{{ $value->id }}" 
                                value="{{ $value->id }}" 
                                {{ ($rtlhVerif->custom_field) ? ( ($rtlhVerif->custom_field[$setup->id] == $value->id) ? 'checked' : '') : '' }}>
                                <label class="form-check-label" for="custom_field{{ $value->id }}">{{  $value->name }}</label>
                              </div>
                              @endforeach
                            </div>
                          </div>
                          ...
                          <!-- <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Berpenghasilan di bawah UMP/UMK</label>
                            <div class="col-sm-12 col-md-7">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="dibawah_umk" type="radio" id="dibawah_umk1" value="1">
                                <label class="form-check-label" for="dibawah_umk1">Ya</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="dibawah_umk" type="radio" id="dibawah_umk2" value="0">
                                <label class="form-check-label" for="dibawah_umk2">Tidak</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Sudah Berkeluarga</label>
                            <div class="col-sm-12 col-md-7">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="sudah_berkeluarga" type="radio" id="sudah_berkeluarga1" value="1">
                                <label class="form-check-label" for="sudah_berkeluarga1">Ya</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="sudah_berkeluarga" type="radio" id="sudah_berkeluarga2" value="0">
                                <label class="form-check-label" for="sudah_berkeluarga2">Tidak</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Memiliki atau menguasai tanah dengan alas hak yang sah</label>
                            <div class="col-sm-12 col-md-7">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="menguasai_tanah" type="radio" id="menguasai_tanah1" value="1">
                                <label class="form-check-label" for="menguasai_tanah1">Ya</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="menguasai_tanah" type="radio" id="menguasai_tanah2" value="0">
                                <label class="form-check-label" for="menguasai_tanah2">Tidak</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Belum memiliki rumah atau memiliki dan menempati satu-satunya RTLH</label>
                            <div class="col-sm-12 col-md-7">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="blm_memiliki_rumah" type="radio" id="blm_memiliki_rumah1" value="1">
                                <label class="form-check-label" for="blm_memiliki_rumah1">Ya</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="blm_memiliki_rumah" type="radio" id="blm_memiliki_rumah2" value="0">
                                <label class="form-check-label" for="blm_memiliki_rumah2">Tidak</label>
                              </div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Belum pernah menerima bantuan program perumahan dari pemerintah</label>
                            <div class="col-sm-12 col-md-7">
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="blm_menerima_bantuan" type="radio" id="blm_menerima_bantuan1" value="1">
                                <label class="form-check-label" for="blm_menerima_bantuan1">Ya</label>
                              </div>
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="blm_menerima_bantuan" type="radio" id="blm_menerima_bantuan2" value="0">
                                <label class="form-check-label" for="blm_menerima_bantuan2">Tidak</label>
                              </div>
                            </div>
                          </div> -->
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Status Verifikasi</label>
                            <div class="col-sm-12 col-md-7">
                              <select class="form-control selectric" name="stts_verif">  
                                <option value="1" {{ ( $rtlhVerif->stts_verif == 1) ? 'selected' : '' }}>Terima</option>
                                <option value="2" {{ ( $rtlhVerif->stts_verif == 2) ? 'selected' : '' }}>Tolak</option>
                                <option value="3" {{ ( $rtlhVerif->stts_verif == 3) ? 'selected' : '' }}>Perlu Perbaikan</option>
                              </select>
                              <div class="invalid-feedback feedback-stts-verif"></div>
                            </div>
                          </div>
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Catatan</label>
                            <div class="col-sm-12 col-md-7">
                              <textarea class="form-control selectric" name="catatan" rows="" style="height: 50px;">{{ $rtlhVerif->catatan }}</textarea>
                              <div class="invalid-feedback feedback-catatan"></div>
                            </div>
                          </div>
                          <!-- <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                            <div class="col-sm-6 col-md-3">
                              <button type="button" class="btn btn-secondary btn-kembali mr-2" data-target="#uploads"><i class="fas fa-angle-double-left"></i> Kembali</button>
                            </div>
                            <div class="col-sm-6 col-md-4 text-right">
                              <input type="hidden" name="id_rtlh" value="{{ $rtlh->id }}">
                              <button class="btn btn-success" type="submit"> <i class="fas fa-save"></i> Simpan</button>
