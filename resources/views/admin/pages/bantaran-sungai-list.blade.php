<x-admin-layout>
  ...
  <x-slot name="title">Data Penanganan di Bantaran Sungai</x-slot>
    ...
    <section class="section">
      <div class="section-header customs">
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Data Penanganan di Bantaran Sungai</div>
        </div>
      </div>
                ...
                <div class="d-flex justify-content-between mb-4">
                    <div>
                        ...
                        <div class="small text-medium-emphasis">
                            Data Penanganan di Bantaran Sungai
                        </div>
                    </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group required">
                ...
                <input type="text" name="jenis_penanganan" class="form-control" required>
                <div class="invalid-feedback">Jenis Penangan wajib diisi.</div>
            </div>
            <div class="form-group required">
                <label>Luas/Panjang</label>
                <select class="form-control selectric" name="jenis" id="jenis" required>
                    <option value="">Pilih....</option>
                    <option value="Luas">Luas</option>
                    <option value="Panjang">Panjang</option>
                </select>
                <div class="invalid-feedback">Foield ini Wajib diisi.</div>
            </div>
        </div>
  ...
  <x-slot name="extra_js">
    ...
    $(function() {
      ...
      var dataTable = $('#dataTable').DataTable({
        ...
        // ordering: false,
        ajax: {
            url: '{{ route('admin.bantaran-sungai.getDataTables') }}',
            data: function (d) {
                //
            }
        },
      ...
      $('#btn-create').click(function () {
        var url = '{{ route("admin.bantaran-sungai.store") }}';
      ...
      $('#dataTable tbody').on( 'click', '.btn-hapus', function () {
        var id = $(this).data('id');
        var url = '{{ route("admin.bantaran-sungai.destroy", ":id") }}';
        url = url.replace(':id', id);
        swal({
          ...
          $.ajax({
              ...
              success: function(data, textStatus, jqXHR) {
                ...
                if (data['status'] == true) {
                  ...
                  .then((value) => {
                    window.location = "{{ route('admin.bantaran-sungai.index') }}";
                  });
                }
                else {
      ...
      $('#dataTable tbody').on( 'click', '.btn-edit', function () {
          ...
          $('#formModal').modal('show')
          var url = '{{ route("admin.bantaran-sungai.update", ":id") }}';
