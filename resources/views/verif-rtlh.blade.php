                  ...
                  <fieldset>
                    <div class="card-body">
                      <ul class="nav nav-tabs nav-justified" id="myTab5" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link" id="uploads-tab" data-toggle="tab" href="#uploads" role="tab" aria-controls="uploads" aria-selected="false">
                            4. Uploads</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="tab-pane fade" id="kelayakan" role="tabpanel" aria-labelledby="kelayakan-tab">
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-6 col-md-4 text-right">
                              ...
                              <button type="button" class="btn btn-primary btn-lanjut" data-type="kelayakan" data-target="#uploads">Lanjut <i class="fas fa-angle-double-right"></i></button>
                            </div>
                          </div>
                        </div>
                        <div class="tab-pane fade" id="uploads" role="tabpanel" aria-labelledby="uploads-tab">
                          
                          @foreach ($uploads as $setup)
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ $setup->name }}</label>
                            <div class="col-sm-12 col-md-7">
                              <input type="file" class="form-control" name="uploads_{{ $setup->id }}">
                              <div class="invalid-feedback feedback-uploads_{{ $setup->id }}"></div>
                            </div>
                          </div>
                          @endforeach
                          ...
                          <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
                            <div class="col-sm-6 col-md-3">
                              <button type="button" class="btn btn-secondary btn-kembali mr-2" data-target="#kelayakan"><i class="fas fa-angle-double-left"></i> Kembali</button>
                            </div>
                            <div class="col-sm-6 col-md-4 text-right">
                        ...
                        <div class="tab-pane fade" id="verifikasi" role="tabpanel" aria-labelledby="verifikasi-tab">
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              ...
                              <div class="form-check form-check-inline">
                                <input class="form-check-input" name="custom_field[{{ $setup->id}}]" type="radio" id="custom_field{{ $value->id }}" value="{{ $value->id }}">
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              <textarea class="form-control selectric" name="catatan" rows="" style="height: 50px;"></textarea>
